//  Decay0.cc
// Contact person: Aleksandra Bialek <abialek@ualberta.ca> 
// See  Decay0.hh for more details
//———————————————————————//
...
void Decay0::GenBackgTest()
{
  ...
  info<<"taking data for isotope: "<<fIsotope<<endl; 
  try{fEbindeK = fLdecay->GetD("EbindeK");} catch (DBNotFoundError &e){;}
...
void Decay0::GenEvent()
{
  ...
  if (fIsotope=="Ac228") Ac228();
  ...
  else if (fIsotope=="BiPo212-500"){ // Special BiPo decay within 500ns
     Bi212();
     int fNbPart0=fNbPart;
     ...
     if (fNpGeant[1]!=47){    ///decay of Po212
        ...
        while( time > 500.0e-9 )  // 500ns cut off here
  ...
  else if (fIsotope=="BiPo214-500"){ // Special BiPo decay within 500ns
     Bi214();
     int fNbPart0=fNbPart;
...
void Decay0::bb()
{
  ...
  if (fStartbb==0){
     ...
     printf("calculation of the theoretical spectrum\n");
...
void Decay0::Ac228()
{
  ...
  pbeta =100.*GetRandom();
  if (pbeta<= fProbBeta[0]){   // 0.20%
     beta(fEndPoint[0],0.,0.);
     p=100*GetRandom();
     if (p<=31.){
        nucltransK(fEnGamma[0],fEbindeK,3.2e-3,0.);
        next969=true;
     }
     else{
        nucltransK(fEnGamma[1],fEbindeK,3.0e-3,0.);
        next964=true;
     }
  }
  else if (pbeta<=fProbBeta[1]){   // 0.20%
     beta(fEndPoint[1],0.,0.);
     p=100*GetRandom();
     if (p<=42.){
        nucltransK(fEnGamma[2],fEbindeK,2.8e-3,1.6e-4);
        next58=true;
     }
     else if (p<=72.){
        nucltransK(fEnGamma[3],fEbindeK,7.0e-3,1.7e-4);
        next129=true;
     }
     else{
        nucltransK(fEnGamma[4],fEbindeK,0.7e+0,0.);
        next10910=true;
     }
  }
  else if (pbeta<=fProbBeta[2]){      // 0.04%
     beta(fEndPoint[2],0.,0.);
     p=100*GetRandom();
     if (p<=33.){
        nucltransK(fEnGamma[5],fEbindeK,1.2e-3,2.9e-4);
        return;
     }
     else{
        nucltransK(fEnGamma[6],fEbindeK,1.8e-3,2.7e-4);
        next58=true;
     }
  }
  else if (pbeta<=fProbBeta[3]){      // 0.23%
     beta(fEndPoint[3],0.,0.);
     p=100*GetRandom();
     if (p<=31.4){
        nucltransK(fEnGamma[7],fEbindeK,3.0e-3,1.3e-4);
        next58=true;
     }
     else if (p<=42.4){
        nucltransK(fEnGamma[8],fEbindeK,1.0e-2,2.0e-4);
        next129=true;
     }
     else if (p<=44.3){
        nucltransK(fEnGamma[9],fEbindeK,1.7e-3,0.6e-4);
        next338=true;
     }
     else if (p<=75.7){
        nucltransK(fEnGamma[10],fEbindeK,4.0e-2,0.);
        next969=true;
     }
     else if (p<=87.8){
        nucltransK(fEnGamma[11],fEbindeK,4.5e-2,0.);
        next964=true;
     }
     else if (p<=89.0){
        nucltransK(fEnGamma[12],fEbindeK,5.5e-2,0.);
        next10910=true;
     }
     else if (p<=94.0){
        nucltransK(fEnGamma[13],fEbindeK,6.5e-2,0.);
        next1154=true;
     }
     else if (p<=96.0){
        nucltransK(fEnGamma[14],fEbindeK,7.5e-2,0.);
        next178=true;
     }
     else{
        nucltransK(fEnGamma[15],fEbindeK,2.1e+0,0.);
        next1724=true;
     }
  }
  else if (pbeta<=fProbBeta[4]){     // 0.10%
     beta(fEndPoint[4],0.,0.);
     p=100*GetRandom();
     if (p<=1.7){
        nucltransK(fEnGamma[16],fEbindeK,3.0e-3,1.3e-4);
        return;
     }
     else if (p<=20.7){
        nucltransK(fEnGamma[17],fEbindeK,8.0e-3,2.0e-4);
        next58=true;
     }
     else if (p<=21.7){
        nucltransK(fEnGamma[18],fEbindeK,3.5e-3,0.8e-4);
        next129=true;
     }
     else if (p<=31.7){
        nucltransK(fEnGamma[19],fEbindeK,1.7e-3,0.5e-4);
        next338=true;
     }
     else if (p<=67.9){
        nucltransK(fEnGamma[20],fEbindeK,4.3e-3,0.);
        next1017=true;
     }
     else{
        nucltransK(fEnGamma[21],fEbindeK,1.6e-2,0.);
        next1054=true;
     }
  }
  else if (pbeta<=fProbBeta[5]){     // 0.14%
     beta(fEndPoint[5],0.,0.);
     p=100*GetRandom();
     if (p<=17.0){
        nucltransK(fEnGamma[22],fEbindeK,6.0e-3,2.0e-4);
        next58=true;
     }
     else if (p<=22.6){
        nucltransK(fEnGamma[23],fEbindeK,1.0e-2,1.0e-4);
        next129=true;
     }
     else if (p<=38.6){
        nucltransK(fEnGamma[24],fEbindeK,1.0e-1,0.);
        next952=true;
     }
     else if (p<=47.6){
        nucltransK(fEnGamma[25],fEbindeK,4.5e-2,0.);
        next969=true;
     }
     else if (p<=74.8){
        ...
        nucltransK(fEnGamma[27],fEbindeK,3.3e-1,0.);
        next1154=true;
     }
     else if (p<=77.8){
        nucltransK(fEnGamma[28],fEbindeK,1.2e-1,0.);
        next178=true;
     }
     else{
        nucltransK(fEnGamma[29],fEbindeK,2.8e-1,0.);
        next1374=true;
     }
  }
  else if (pbeta<=fProbBeta[6]){     // 0.11%
     beta(fEndPoint[6],0.,0.);
     p=100*GetRandom();
     if (p<=62.){
        nucltransK(fEnGamma[30],fEbindeK,1.4e-3,1.1e-4);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[31],fEbindeK,1.7e-3,0.7e-4);
        next129=true;
     }
  }
  else if (pbeta<=fProbBeta[7]){    // 0.29%
     beta(fEndPoint[7],0.,0.);
     p=100*GetRandom();
     if (p<=32.){
        nucltransK(fEnGamma[32],fEbindeK,1.4e-3,1.6e-4);
        next58=true;
     }
     else if (p<=94.){
        nucltransK(fEnGamma[33],fEbindeK,1.7e-3,0.6e-4);
        next129=true;
     }
     else{
        nucltransK(fEnGamma[34],fEbindeK,2.0e-3,0.2e-4);
        next338=true;
     }
  }
  else if (pbeta<=fProbBeta[8]){    // 1.50%
     beta(fEndPoint[8],0.,0.);
     next1724=true;
  }
  else if (pbeta<=fProbBeta[9]){    // 2.10%
     beta(fEndPoint[9],0.,0.);
     p=100*GetRandom();
     if (p<=72.3){
        nucltransK(fEnGamma[35],fEbindeK,7.4e-3,1.2e-4);
        next58=true;
     }
     else if (p<=98.0){
        nucltransK(fEnGamma[36],fEbindeK,1.7e-3,0.5e-4);
        next129=true;
     }
     else{
        nucltransK(fEnGamma[37],fEbindeK,7.5e-3,0.);
        next964=true;
     }
  }
  else if (pbeta<=fProbBeta[10]){    // 1.50%
     beta(fEndPoint[10],0.,0.);
     p=100*GetRandom();
     if (p<=22.){
        nucltransK(fEnGamma[38],fEbindeK,1.5e-3,0.8e-4);
        next58=true;
     }
     else if (p<=90.){
        nucltransK(fEnGamma[39],fEbindeK,1.7e-3,0.5e-4);
        next129=true;
     }
     else if (p<=96.){
        nucltransK(fEnGamma[40],fEbindeK,2.2e-3,0.2e-4);
        next338=true;
     }
     else{
        nucltransK(fEnGamma[41],fEbindeK,2.6e-3,0.1e-4);
        next332=true;
     }
  }
  else if (pbeta<=fProbBeta[11]){   // 4.70%
     beta(fEndPoint[11],0.,0.);
     p=100*GetRandom();
     if (p<=75.0){
        nucltransK(fEnGamma[42],fEbindeK,4.7e-3,0.5e-4);
        next58=true;
     }
     else if (p<=95.0){
        nucltransK(fEnGamma[43],fEbindeK,5.0e-3,0.3e-4);
        next129=true;
     }
     else if (p<=96.0){
        nucltransK(fEnGamma[44],fEbindeK,2.2e-2,0.);
        next969=true;
     }
     else if (p<=96.4){
        nucltransK(fEnGamma[45],fEbindeK,8.0e-3,0.);
        next964=true;
     }
     else if (p<=97.4){
        nucltransK(fEnGamma[46],fEbindeK,1.6e-1,0.);
        next10910=true;
     }
     else if (p<=99.5){
        nucltransK(fEnGamma[47],fEbindeK,1.2e-2,0.);
        next1123=true;
     }
     else{
  ...
  else if (pbeta<=fProbBeta[12]){  // 0.80%
     beta(fEndPoint[12],0.,0.);
     p=100*GetRandom();
     if (p<=1.0){
        nucltransK(fEnGamma[49],fEbindeK,1.8e-2,0.6e-4);
        next328=true;
     }
     else if (p<=51.7){
        nucltransK(fEnGamma[50],fEbindeK,2.1e-2,0.4e-4);
        next338=true;
     }
     else if (p<=61.7){
        nucltransK(fEnGamma[51],fEbindeK,7.0e-3,0.);
        next969=true;
     }
     else if (p<=70.7){
        nucltransK(fEnGamma[52],fEbindeK,8.0e-3,0.);
        next964=true;
     }
     else{
        nucltransK(fEnGamma[53],fEbindeK,7.9e-2,0.);
        next1374=true;
     }
  }
  else if (pbeta<=fProbBeta[13]){  // 1.20%
     beta(fEndPoint[13],0.,0.);
     p=100*GetRandom();
     if (p<=38.){
        nucltransK(fEnGamma[54],fEbindeK,4.0e-3,0.5e-4);
        return;
     }
     else if (p<=96.){
        nucltransK(fEnGamma[55],fEbindeK,1.1e-2,1.1e-4);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[56],fEbindeK,1.2e-2,0.);
        next1123=true;
     }
  }
  else if (pbeta<=fProbBeta[14]){  // 0.07%
     beta(fEndPoint[14],0.,0.);
     p=100*GetRandom();
     if (p<=50.){
        nucltransK(fEnGamma[57],fEbindeK,2.7e-3,0.2e-4);
        next191=true;
     }
     else if (p<=86.){
        nucltransK(fEnGamma[58],fEbindeK,2.2e-2,0.);
        next1110=true;
     }
     else{
        nucltransK(fEnGamma[59],fEbindeK,2.2e-2,0.);
        next988=true;
     }
  }
  else if (pbeta<=fProbBeta[15]){  // 0.20%
     beta(fEndPoint[15],0.,0.);
     p=100*GetRandom();
     if (p<=12.){
        nucltransK(fEnGamma[60],fEbindeK,1.8e-3,0.5e-4);
        next58=true;
     }
     else if (p<=18.){
        nucltransK(fEnGamma[61],fEbindeK,2.6e-2,0.3e-4);
        next338=true;
     }
     else if (p<=32.){
        nucltransK(fEnGamma[62],fEbindeK,1.0e-2,0.);
        next332=true;
     }
     else{
        nucltransK(fEnGamma[63],fEbindeK,1.5e-1,0.);
        next641=true;
     }
  }
  else if (pbeta<=fProbBeta[16]){ // 8.00%
     beta(fEndPoint[16],0.,0.);
     p=100*GetRandom();
     if (p<=0.4){
        nucltransK(fEnGamma[64],fEbindeK,2.8e-3,0.2e-4);
        next338=true;
     }
     else if (p<=30.7){
        ...
        nucltransK(fEnGamma[66],fEbindeK,6.0e-2,0.);
        next964=true;
     }
     else if (p<=51.3){
        nucltransK(fEnGamma[67],fEbindeK,3.0e-1,0.);
        next10910=true;
     }
     else if (p<=52.3){
        nucltransK(fEnGamma[68],fEbindeK,4.5e-1,0.);
        next1154=true;
     }
     else if (p<=53.0){
        nucltransK(fEnGamma[69],fEbindeK,1.7e+0,0.);
        next988=true;
     }
     else{
        nucltransK(fEnGamma[70],0.020,4.0e+0,0.);
        next1374=true;
     }
  }
  else if (pbeta<=fProbBeta[17]){  // 0.20%
     beta(fEndPoint[17],0.,0.);
     p=100*GetRandom();
     if (p<=22.){
        nucltransK(fEnGamma[71],fEbindeK,2.0e-2,0.);
        next10910=true;
     }
     else{
        nucltransK(fEnGamma[72],fEbindeK,0.6e+0,0.);
        next988=true;
     }
  }
  else if (pbeta<=fProbBeta[18]){  // 1.90%
     beta(fEndPoint[18],0.,0.);
     next1054=true;
  }
  else if (pbeta<=fProbBeta[19]){  // 1.50%
     beta(fEndPoint[19],0.,0.);
     next1374=true;
  }
  else if (pbeta<=fProbBeta[20]){  // 0.20%
     beta(fEndPoint[20],0.,0.);
     p=100*GetRandom();
     if (p<=27.0){
        nucltransK(fEnGamma[73],fEbindeK,3.5e-3,0.);
        next328=true;
     }
     else if (p<=64.5){
        nucltransK(fEnGamma[74],fEbindeK,3.7e-3,0.);
        next338=true;
     }
     else if (p<=95.0){
        nucltransK(fEnGamma[75],fEbindeK,5.0e-3,0.);
        next332=true;
     }
     else{
        nucltransK(fEnGamma[76],fEbindeK,1.4e-1,0.);
        next988=true;
     }
  }
  else if (pbeta<=fProbBeta[21]){  // 0.80%
     beta(fEndPoint[21],0.,0.);
     next1040=true;
  }
  else if (pbeta<=fProbBeta[22]){  // 3.60%
     beta(fEndPoint[22],0.,0.);
     next1110=true;
  }
  else if (pbeta<=fProbBeta[23]){   // 5.00%
     beta(fEndPoint[23],0.,0.);
     next1154=true;
  }
  else if (pbeta<=fProbBeta[24]){   // 5.40%
     beta(fEndPoint[24],0.,0.);
     next1123=true;
  }
  else if (pbeta<=fProbBeta[25]){   // 0.10%
     beta(fEndPoint[25],0.,0.);
     p=100*GetRandom();
     if (p<=74.){
        nucltransK(fEnGamma[77],fEbindeK,3.5e-3,0.);
        next58=true;
     }
     else if (p<=87.){
        nucltransK(fEnGamma[78],fEbindeK,7.0e-3,0.);
        next338=true;
     }
     else{
  ...
  else if (pbeta<=fProbBeta[26]){   // 2.00%
     beta(fEndPoint[26],0.,0.);
     next964=true;
  }
  else if (pbeta<=fProbBeta[27]){   // 0.20%
     beta(fEndPoint[27],0.,0.);
     next1017=true;
  }
  else if (pbeta<=fProbBeta[28]){   // 0.10%
     beta(fEndPoint[28],0.,0.);
     next651=true;
  }
  else if (pbeta<=fProbBeta[29]){   // 31.95%
     beta(fEndPoint[29],0.,0.);
     next969=true;
  }
  else if (pbeta<=fProbBeta[30]){   // 0.30%
     beta(fEndPoint[30],0.,0.);
     next641=true;
  }
  else if (pbeta<=fProbBeta[31]){   // 0.23%
     beta(fEndPoint[31],0.,0.);
     p=100*GetRandom();
     if (p<=42.5){
        nucltransK(fEnGamma[80],fEbindeK,1.1e-2,0.);
        return;
     }
     else if(p<=57.5){
        nucltransK(fEnGamma[81],fEbindeK,7.5e-1,0.);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[82],fEbindeK,8.5e-3,0.);
        next328=true;
     }
  }
  else if (pbeta<=fProbBeta[32]){   // 0.14%
     beta(fEndPoint[32],0.,0.);
     next874=true;
  }
  else if (pbeta<=fProbBeta[33]){   // 0.20%
     beta(fEndPoint[33],0.,0.);
     next332=true;
  }
  else if (pbeta<=fProbBeta[34]){   // 13.00%
     beta(fEndPoint[34],0.,0.);
     next338=true;
  }
  else if (pbeta<=fProbBeta[35]){   //0.80%
  ...
  if (next1054){
     p=100*GetRandom();
     if (p<=3.0){
        nucltransK(fEnGamma[83],fEbindeK,3.2e-2,0.);
        next338=true;
     }
     else if (p<=15.0){
        nucltransK(fEnGamma[84],fEbindeK,4.2e-2,0.);
        next952=true;
     }
     else if (p<=16.5){
        nucltransK(fEnGamma[85],fEbindeK,2.5e-1,0.);
        next641=true;
     }
     else if (p<=58.0){
        nucltransK(fEnGamma[86],fEbindeK,4.4e-2,0.);
        next1123=true;
     }
     else if (p<=82.0){
        nucltransK(fEnGamma[87],fEbindeK,1.3e+0,0.);
        next1110=true;
     }
     else{
        nucltransK(fEnGamma[88],fEbindeK,1.5e+0,0.);
        next1040=true;
     }
  }
  if (next1724){
     p=100*GetRandom();
     if (p<=2.0){
        nucltransK(fEnGamma[89],fEbindeK,3.7e-3,0.7e-4);
        return;
     }
     else if (p<=15.0){
        nucltransK(fEnGamma[90],fEbindeK,1.0e-2,1.2e-4);
        next58=true;
     }
     else if (p<=15.8){
        nucltransK(fEnGamma[91],fEbindeK,4.0e-3,0.4e-4);
        next129=true;
     } 
     else if (p<=89.0){
        nucltransK(fEnGamma[92],fEbindeK,6.9e-2,0.);
        next969=true;
     }
     else{
        nucltransK(fEnGamma[93],fEbindeK,9.5e-2,0.);
        next964=true;
     }
  }
  if (next1374){
     p=100*GetRandom();
     if (p<=1.0){
        nucltransK(fEnGamma[94],fEbindeK,1.4e-2,0.7e-4);
        next58=true;
     }
     else if (p<=3.0){
        nucltransK(fEnGamma[95],fEbindeK,2.0e-2,0.4e-4);
        next129=true;
     }
     else if (p<=64.8){
        nucltransK(fEnGamma[96],fEbindeK,4.7e-2,0.);
        next969=true;
     }
     else if (p<=92.2){
        nucltransK(fEnGamma[97],fEbindeK,8.3e-2,0.);
        next964=true;
     }
     else if (p<=98.2){
        nucltransK(fEnGamma[98],fEbindeK,1.2e-1,0.);
        next10910=true;
     }
     else if (p<=99.0){
        nucltransK(fEnGamma[99],fEbindeK,3.5e-2,0.);
        next1123=true;
     }
     else if (p<=99.6){
        nucltransK(fEnGamma[100],fEbindeK,5.0e-2,0.);
        next1110=true;
     }
     else{
        nucltransK(fEnGamma[101],fEbindeK,5.0e-2,0.);
        next988=true;
     }
  }
  if (next1040){
     p=100*GetRandom();
     if (p<=10.){
        nucltransK(fEnGamma[102],fEbindeK,3.5e-3,0.);
        next129=true;
     } 
     else if (p<=68.){
        nucltransK(fEnGamma[103],fEbindeK,1.8e-2,0.);
        next338=true;
     }
     else if (p<=79.){
        nucltransK(fEnGamma[104],fEbindeK,1.0e-1,0.);
        next332=true;
     }
     else if (p<=97.){
        nucltransK(fEnGamma[105],fEbindeK,9.0e-2,0.);
        next964=true;
     }
     else{
        nucltransK(fEnGamma[106],fEbindeK,1.7e+0,0.);
        next10910=true;
     }
  }
  if (next178){
     nucltransK(fEnGamma[107],fEbindeK,6.0e+1,0.);
     next964=true;
  }
  ...
  if (next1110){
     p=100*GetRandom();
     if (p<=11.0){
        nucltransK(fEnGamma[108],fEbindeK,2.9e-3,0.1e-4);
        next58=true; 
     }   
     else if (p<=38.8){
        nucltransK(fEnGamma[109],fEbindeK,1.4e-2,0.);
        next328=true;
     }
     else if (p<=84.5){
        nucltransK(fEnGamma[110],fEbindeK,1.5e-2,0.);
        next338=true;
     }
     else if (p<=93.8){
        nucltransK(fEnGamma[111],fEbindeK,9.5e-2,0.);
        next969=true;
     }
     else if (p<=98.9){
        nucltransK(fEnGamma[112],fEbindeK,1.2e+0,0.);
        next964=true;
     }
     else{
        nucltransK(fEnGamma[113],0.020,2.2e-1,0.);
        next10910=true;   
     }
  }
  if (next1154){
     p=100*GetRandom();
     if (p<=14.9){
        nucltransK(fEnGamma[114],fEbindeK,7.5e-3,0.1e-4);
        return; 
     }
     else if (p<=25.8){
        nucltransK(fEnGamma[115],fEbindeK,2.8e-2,0.1e-4);
        next58=true;
     }
     else if (p<=40.7){
        nucltransK(fEnGamma[116],fEbindeK,2.0e-2,0.);
        next129=true;
     }
     else if (p<=61.4){
        nucltransK(fEnGamma[117],fEbindeK,5.2e-1,0.);
        next832=true;
     }
     else if (p<=84.1){
        nucltransK(fEnGamma[118],fEbindeK,1.3e+0,0.);
        next874=true;
     }
     else if (p<=93.0){
        nucltransK(fEnGamma[119],fEbindeK,5.4e+1,0.);
        next969=true;
     }
     else if (p<=97.0){
        nucltransK(fEnGamma[120],fEbindeK,1.4e+0,0.);
        next651=true; 
     }
     else{
        nucltransK(fEnGamma[121],fEbindeK,4.9e+0,0.);
        next1017=true;       
     }
  }
  if (next1123){
     p=100*GetRandom();
     if (p<=1.4){
        nucltransK(fEnGamma[122],fEbindeK,6.5e-2,0.1e-4);
        return;
     }
     else if (p<=5.4){
        nucltransK(fEnGamma[123],fEbindeK,3.2e-3,0.);
        next58=true;
     }
     else if (p<=5.6){
        nucltransK(fEnGamma[124],fEbindeK,0.1e+0,0.);
        next129=true;
     }
     else if (p<=73.8){
        nucltransK(fEnGamma[125],fEbindeK,1.9e-2,0.);
        next328=true;
     }
     else if (p<=85.8){
        nucltransK(fEnGamma[126],fEbindeK,1.0e-2,0.);
        next338=true;
     }
     else if (p<=98.1){
        nucltransK(fEnGamma[127],fEbindeK,0.2e+0,0.);
        next969=true;      
     }
     else{
        nucltransK(fEnGamma[128],0.020,3.3e-1,0.);
        next964=true;
    }
  }
  if (next988){
     p=100*GetRandom();
     if (p<=67.){
        nucltransK(fEnGamma[129],fEbindeK,3.5e-3,0.);
        next129=true;
     }
     else{
        nucltransK(fEnGamma[130],fEbindeK,5.2e-3,0.);
        next191=true;  
     }
  }
  if (next1017){
     p=100*GetRandom();
     if (p<=19.){
        nucltransK(fEnGamma[131],fEbindeK,2.4e-2,0.);
        return;
     } 
     else if (p<=66.){
        nucltransK(fEnGamma[132],fEbindeK,3.8e-3,0.);
        next58=true;
     }
     else if (p<=82.){
        nucltransK(fEnGamma[133],fEbindeK,2.1e-2,0.);
        next328=true;
     }
     else{
        nucltransK(fEnGamma[134],fEbindeK,1.4e-1,0.);
        next338=true;
     }
  }
  if (next651){
     p=100*GetRandom();
     if (p<=35.){
        nucltransK(fEnGamma[135],fEbindeK,7.5e-3,0.);
        next328=true;
     }
     else{
        nucltransK(fEnGamma[136],fEbindeK,9.5e-3,0.);
        next338=true;
     }
  }
  if (next952){
     p=100*GetRandom();
     if (p<=91.){
        nucltransK(fEnGamma[137],fEbindeK,4.2e-3,0.);
        next58=true;
     }
     else if (p<=94.){
        nucltransK(fEnGamma[138],fEbindeK,1.2e-1,0.);
        next328=true;
     }
     else{
        nucltransK(fEnGamma[139],fEbindeK,3.5e-2,0.);
        next338=true;
     }
  }
  if (next641){
     p=100*GetRandom();
     if (p<=22.){
        nucltransK(fEnGamma[140],fEbindeK,1.1e-1,0.);
        next328=true;
     }
     else{
        nucltransK(fEnGamma[141],fEbindeK,1.3e-1,0.);
        next338=true; 
     }
  }
  if (next964){
     p=100*GetRandom();
     if (p<=73.){
        nucltransK(fEnGamma[142],fEbindeK,9.2e-3,0.);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[143],fEbindeK,1.4e-2,0.);
        next129=true; 
     }
  }
  if (next969){
     p=100*GetRandom();
     if (p<=37.0){
        nucltransK(fEnGamma[144],fEbindeK,1.0e-2,0.);
        return;
     }
     else if (p<=98.8){
        nucltransK(fEnGamma[145],fEbindeK,1.2e-2,0.);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[146],fEbindeK,6.8e-2,0.);
        next129=true; 
     }
  }
  if (next10910){
     p=100*GetRandom();
     if (p<=21.){
        nucltransK(fEnGamma[147],fEbindeK,9.5e-3,0.);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[148],fEbindeK,2.6e-2,0.);
        next129=true;
     }
  }
  if (next832){
     ...
     if (p<=4.){
        ...
        nucltransK(fEnGamma[149],fEbindeK,1.7e-2,0.);
        next58=true;
    }
    else{
       nucltransK(fEnGamma[150],fEbindeK,1.2e-2,0.);
       next328=true;
    }
  }
  if (next874){
     p=100*GetRandom();
     if (p<=15.){
        nucltransK(fEnGamma[151],fEbindeK,1.3e-2,0.);
        return;
     } 
     else if (p<=26.){
        nucltransK(fEnGamma[152],fEbindeK,0.5e+0,0.);
        next58=true;
     }
     else if (p<=60.){
        nucltransK(fEnGamma[153],fEbindeK,1.1e-2,0.);
        next328=true;
     }
     else{
        nucltransK(fEnGamma[154],fEbindeK,1.4e-2,0.);
        next338=true;
     }
  } 
  if (next332){
     p=100*GetRandom();
     if (p<=90.){
        nucltransK(fEnGamma[155],fEbindeK,4.7e-1,0.);
        next129=true;
     }
     else{
        nucltransK(fEnGamma[156],fEbindeK,0.9e+0,0.);
        next191=true;
     }
  }
  if (next338){
     p=100*GetRandom();
     if (p<=73.){
        nucltransK(fEnGamma[157],fEbindeK,1.0e-2,0.);
        next58=true;
     }
     else{
        nucltransK(fEnGamma[158],fEbindeK,7.9e-2,0.);
        next129=true;
     }
  }
  if (next328){
     p=100*GetRandom();
     if (p<=47.){
        nucltransK(fEnGamma[159],fEbindeK,4.4e-2,0.);
        return; 
     } 
     else{
        nucltransK(fEnGamma[160],fEbindeK,3.4e-2,0.);
        next58=true;
     } 
  }
  if (next191){
     nucltransK(fEnGamma[161],fEbindeK,4.2e-1,0.);
     next129=true;
  }
  if (next129){
     fThlev=0.16e-9;
     nucltransK(fEnGamma[162],0.020,2.7e+0,0.);
     next58=true;    
  }
  if (next58){
     fThlev=0.40e-9;
     nucltransK(fEnGamma[163],0.020,1.2e+2,0.);
     return;    
  }
}
///^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
///************************************************/
void Decay0::nucltransK(float fEgamma,float Ebinde,float conve,float convp)
{
  ...
  // (usually with fEgamma-E(K)_binding_energy).
  ...
  if (p<=1) {
    particle(1,fEgamma,fEgamma,0,pi,0,twopi,fTclev,fThlev);//gamma
  }
  else if (p<=1+conve){
    particle(3,fEgamma-Ebinde,fEgamma-Ebinde,0.,pi,0.,twopi,fTclev,fThlev);//electron
    particle(1,Ebinde,Ebinde,0.,pi,0.,twopi,0.,0.);//gamma
  }
  else pair(fEgamma-2.*GetMass(3));//e+e- pair
  return; 
}
///************************************************/
...
///************************************************/
void Decay0::nucltransKLM(float fEgamma,float EbindeK,float conveK,float EbindeL,float conveL,float EbindeM,float conveM, float convp)
{
  ...
  // fEgamma-E(K)_binding_energy, fEgamma-E(L)_binding_energy and
  // fEgamma-E(M)_binding_energy.
  ...
  if (p<=1.) particle(1,fEgamma,fEgamma,0.,pi,0.,twopi,fTclev,fThlev);//gamma
  else if (p<=1.+conveK){
     particle(3,fEgamma-EbindeK,fEgamma-EbindeK,0.,pi,0.,twopi,fTclev,fThlev);//electron
     particle(1,EbindeK,EbindeK,0.,pi,0.,twopi,0,0);//gamma
  }
  else if (p<=1.+conveK+conveL){
     particle(3,fEgamma-EbindeL,fEgamma-EbindeL,0.,pi,0.,twopi,fTclev,fThlev);//electron
     particle(1,EbindeL,EbindeL,0.,pi,0.,twopi,0,0);//gamma
  }
  else if (p<=1.+conveK+conveL+conveM){
     particle(3,fEgamma-EbindeM,fEgamma-EbindeM,0.,pi,0.,twopi,fTclev,fThlev);//electron
     particle(1,EbindeM,EbindeM,0.,pi,0.,twopi,0,0);//gamma
  }
  else pair(fEgamma-2.*GetMass(3));
